...
#+BEGIN_SRC python
  ...
  In [5]: fsolve(f, x0=0.1)
  Out[5]: array([ 0.21612385])
#+END_SRC

#+BEAMER: \pause\vskip-1pt
#+ATTR_LATEX: :options fontsize=\scriptsize
#+BEGIN_SRC python
  In [6]: fsolve(f, np.arange(0.1, 3, 0.5))
  Out[6]:
  array([ 0.21612385,  0.6574377 ,  1.116265  ,  1.58938086,  2.071577  ,
          2.55928414])
#+END_SRC
...
#+BEGIN_SRC latex
  \begin{center}
    \includegraphics<2>[width=1.1\linewidth]{figures/scipy_root0.pdf}
    \includegraphics<3>[width=1.1\linewidth]{figures/scipy_root1.pdf}
    \includegraphics<4>[width=1.1\linewidth]{figures/scipy_root2.pdf}
    \includegraphics<5>[width=1.1\linewidth]{figures/scipy_root3.pdf}
    \includegraphics<6>[width=1.1\linewidth]{figures/scipy_root4.pdf}
  \end{center}
#+END_SRC

...
-
  #+BEGIN_SRC python :tangle /tmp/test_euler_project.py
...
1) Ci-dessous la classe =Particle=
   ...
   #+BEGIN_SRC python :tangle /tmp/particle.py
     class Particle:
   ...
   #+BEGIN_SRC python :tangle /tmp/test_particle.py
     import particle
...
2) Classe =Point=
   ...
   #+BEGIN_SRC python :tangle /tmp/point.py
     class Point:
   ...
   #+BEGIN_SRC python :tangle /tmp/vector2d.py
     class Vector2D:
   ...
   #+BEGIN_SRC python :tangle /tmp/test_vector2d.py
     import point as p
     point1 = p.Point(3,4)
     point2 = p.Point(2,7)

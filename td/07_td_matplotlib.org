...
#+RESULTS:
:results:
: <matplotlib.legend.Legend at 0x7ff3a6a3db38>
[[file:./obipy-resources/1526azm.svg]]
:end:
...
#+BEGIN_SRC ipython :session :results raw drawer
  ...
  def trajectory(beta=0, distance=0):
      return [0, distance, 0], [0, distance/beta, 2*distance/beta]

  distance = 4 # a.l
  x, y = trajectory(beta=4/5, distance=distance)
...
#+RESULTS:
:results:
[[file:./obipy-resources/1792NUg.png]]
:end:
